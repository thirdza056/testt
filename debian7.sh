...
# install screenfetch
cd
wget 'https://raw.githubusercontent.com/nifira123/debian7_32bit/master/screenfetch-dev'
...
wget -O /etc/sysctl.d/forwarding.conf "https://raw.githubusercontent.com/nifira123/debian7_32bit/master/forwarding.conf"
...
curl https://raw.githubusercontent.com/nifira123/debian7_32bit/master/iptables.txt > iptables
...
echo ""  | tee -a log-install.txt
echo "Mod by Abu Yazid Al-Busthami"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
